      ...
      <div className="max-w-5xl w-full px-6 md:px-12 py-16 md:py-24">
        ...
        <div className="w-full mb-16 flex items-center justify-between">
          <div className="space-y-4 w-full">
            ...
            <Skeleton className="h-16 w-48 md:w-64 rounded-lg bg-muted" />
            <Skeleton className="h-8 w-full max-w-2xl rounded-lg bg-muted" />
          </div>
        </div>
            ...
            <div key={i} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2 px-1">
                 <div className="flex flex-col gap-2">
                   <Skeleton className="h-3 w-20 bg-muted" /> {/* Universe Badge */}
                   <Skeleton className="h-8 w-3/4 bg-muted" /> {/* Word Title */}
                 </div>
